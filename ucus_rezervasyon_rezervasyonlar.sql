...
CREATE TABLE `rezervasyonlar` (
  ...
  `sinif_turu` enum('ekonomi','business') NOT NULL,
  PRIMARY KEY (`rezervasyon_id`),
  KEY `kullanici_id` (`kullanici_id`),
  KEY `ucus_id` (`ucus_id`),
  CONSTRAINT `rezervasyonlar_ibfk_1` FOREIGN KEY (`kullanici_id`) REFERENCES `kullanicilar` (`kullanici_id`),
  CONSTRAINT `rezervasyonlar_ibfk_2` FOREIGN KEY (`ucus_id`) REFERENCES `ucuslar` (`ucus_id`)
...
INSERT INTO `rezervasyonlar` VALUES (11,1,6,'2024-05-18 16:29:11','18','ekonomi'),(12,1,6,'2024-05-18 16:36:45','2','ekonomi'),(13,1,6,'2024-05-19 00:59:35','1','ekonomi'),(14,1,6,'2024-05-19 02:24:43','3','ekonomi');
